""" Script para probar el método que recorre de manera iterativa en profundidad y en orden un árbol binario ordenado . """
...
""" Test del recorrido iterativo en profundidad y en orden de un árbol binario ordenado """
print("Recorro el árbol en orden en profundidad de manera iterativa: " + str(miArbol.in_orden_prof_iterativo()))

print("\n*** Evaluación en tiempo de ejecución: ***")
eval_tiempo(miArbol, "eval_in_orden_prof_iterativo")

print("\n*** Evaluación del uso de la memoria: *** ")
eval_memoria(miArbol, "eval_in_orden_prof_iterativo")
...
print("\n*** Evaluación en tiempo de ejecución: ***")
eval_tiempo(miArbol2, "eval_in_orden_prof_iterativo")

print("\n*** Evaluación del uso de la memoria: *** ")
eval_memoria(miArbol2, "eval_in_orden_prof_iterativo")
